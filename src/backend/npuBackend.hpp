...
public:
    ...
    void attentionSingleHead(float* q,float* k,float* v,float* attnScores,float* out,int pos,int headSize);          //三合一：CPU
    void ropeEncoding(float *q, float *k, int headSize, int position, int dim, int kvDim);                           //CPU
